...
@Component({
  selector: 'app-wather-icon',
  templateUrl: './wather-icon.component.html',
  styleUrls: ['./wather-icon.component.sass']
})
export class WatherIconComponent implements OnInit {


  icon: string = 'weather';
  _code: number;

  //@Input() codeIcon:number;
